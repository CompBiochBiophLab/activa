package com.o2hlink.pimtools.ui.i18n;
...
//		initialVideoURL = "http://c180889.r89.cf1.rackcdn.com/ActivaEnvironmentsDemo.mp4";
		...
		NOTIFICATION_TITLE = "PIM Tool Pro - Notification";
		...
		TEXT_ABOUTUS = "<big>Version %s Madrid</big><br/>" +
				"<br/>PIM Tool Pro© presented by O2H™ and logos are trademarks registered by O2 Heart Link Inc. All rights reserved.<br/>" +
				"<br/>PIM Tool Pro uses open source code under Apache 2.0 license.<br/>";
		...
		TEXT_UPDATEVERSION = "There was a problem during the connection to the server which may be caused because " +
				"you may be using a not updated version of PIM Tool Pro. Please check if there is a more recent version " +
				"of the app.";
		...
		TEXT_GOTOACTIVACENTRAL = "If you want to use this widget, download ActivaCentral";
	...
	public String getFunctionName(int function) {
		return Widget.getNameFromFunction("en", function);
	}
}