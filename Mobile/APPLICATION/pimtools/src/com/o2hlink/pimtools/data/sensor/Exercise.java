...
public class Exercise extends com.o2hlink.pimtools.data.sensor.Sensor {
	...
	int[] order = {com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_INIT, com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_FINAL, com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_AVRG, com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_PEAK, com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_LOW, -1,
		com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_INIT, com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_FINAL, com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_AVRG, com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_PEAK, com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_LOW, -1,
	...
	public Exercise() {
		...
		this.id = com.o2hlink.pimtools.data.sensor.SensorManager.ID_EXERCISE;
		this.instance = this;
		this.state = 0;
	...
	public Sample getSample() {
		...
		firstquestans = Math.round(this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_EXE_ONE));
		secquestans = Math.round(this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_EXE_TWO));
		thrquestans = Math.round(this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_EXE_THREE));
		...
		sample.setDistance(new Double(this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_DISTANCE)));
		...
		sample.setHeartRateInitial(new Double(this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_INIT)));
		sample.setHeartRateFinal(new Double(this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_FINAL)));
		sample.setHeartRateAverage(new Double(this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_AVRG)));
		sample.setHeartRateLow(new Double(this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_LOW)));
		sample.setHeartRatePeak(new Double(this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_PEAK)));
		sample.setOxygenInitial(new Double(this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_INIT)));
		sample.setOxygenFinal(new Double(this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_FINAL)));
		sample.setOxygenAverage(new Double(this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_AVRG)));
		sample.setOxygenLow(new Double(this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_LOW)));
		sample.setOxygenPeak(new Double(this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_PEAK)));
	...
	public String getSensorGlobalResult() {
		...
		if (avrgSo2 < 10.0) {
			Float initSo2 = this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_INIT);
			Float finalSo2 = this.results.get(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_FINAL);
	...
	public void nextStep() {
		...
		switch (this.state) {
			...
			case 3:
				...
				question.append(Activa.myLanguageManager.SENSORS_EXERCISE_CHOICE);
				...
				yes.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						board.setOnClickListener(new OnClickListener() {
							@Override
							public void onClick(View v) {
								((Exercise) Activa.mySensorManager.sensorList.get(com.o2hlink.pimtools.data.sensor.SensorManager.ID_EXERCISE)).track = true;
			...
			case 10:
				this.state = 0;
				((Exercise) Activa.mySensorManager.sensorList.get(com.o2hlink.pimtools.data.sensor.SensorManager.ID_EXERCISE)).results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_BORG_AIR_PRE, borgAirPre);
				((Exercise) Activa.mySensorManager.sensorList.get(com.o2hlink.pimtools.data.sensor.SensorManager.ID_EXERCISE)).results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_BORG_AIR_POST, borgAirPost);
				((Exercise) Activa.mySensorManager.sensorList.get(com.o2hlink.pimtools.data.sensor.SensorManager.ID_EXERCISE)).results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_BORG_FATIGUE_PRE, borgFatiguePre);
				((Exercise) Activa.mySensorManager.sensorList.get(com.o2hlink.pimtools.data.sensor.SensorManager.ID_EXERCISE)).results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_BORG_FATIGUE_POST, borgFatiguePost);
				((Exercise) Activa.mySensorManager.sensorList.get(com.o2hlink.pimtools.data.sensor.SensorManager.ID_EXERCISE)).results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_EXE_ONE, (float) firstquestans);
				((Exercise) Activa.mySensorManager.sensorList.get(com.o2hlink.pimtools.data.sensor.SensorManager.ID_EXERCISE)).results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_EXE_TWO, (float) secquestans);
				((Exercise) Activa.mySensorManager.sensorList.get(com.o2hlink.pimtools.data.sensor.SensorManager.ID_EXERCISE)).results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_EXE_THREE, (float) thrquestans);
				Activa.myApp.setContentView(R.layout.sending);
				SendSensorResult sending = new SendSensorResult(Activa.mySensorManager.sensorList.get(com.o2hlink.pimtools.data.sensor.SensorManager.ID_EXERCISE));
...
//						socket.connect();
					    ...
					    if (finished) {
					    	...
					    	exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_DISTANCE, distance);
					    	...
					    	exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_INIT, this.initHr);
					    	exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_FINAL, this.lastHr);
					    	...
					    	exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_INIT, this.initSo2);
					    	exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_FINAL, this.lastSo2);
...
//						temporizer.cancel();
				    	...
				    	exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_INIT, initHr);
				    	exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_FINAL, lastHr);
				    	...
				    	exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_INIT, initSo2);
				    	exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_FINAL, lastSo2);
						    ...
						    if ((data[0] != -128)&&(data[2] == -128)) {
				  		    ...
				  		    if ((data[0] & 0x7C)!=0x00  || (data[0] & 0x03)==0x03)  {
							    ...
							    if ((so2 < 100.0f)&&(so2 > 60.0f)&&(hr < 220.0f)&&(hr > 20.0f)) {
								    goodMeasure = true;
								    if (atInit) {
									    exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_INIT, hr);
									    exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_INIT, so2);
								    }
								    else {
									    exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_FINAL, hr);
									    exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_FINAL, so2);
								    }
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				animation.start();			
				Activa.myUIManager.loadInfoPopupWithoutExiting(Activa.myLanguageManager.SENSORS_SEARCHING);
//				Toast toast = Toast.makeText(Activa.myApp, Activa.myLanguageManager.SENSORS_SEARCHING, Toast.LENGTH_SHORT);
//				toast.show();
				break;
			case 1:
				animation.stop();
				...
				start = (TextView) Activa.myApp.findViewById(R.id.startText);
				text = (TextView) Activa.myApp.findViewById(R.id.infoText);
...
//				Toast toast2 = Toast.makeText(Activa.myApp, Activa.myLanguageManager.SENSORS_BLUETOOTH_CONFIG, Toast.LENGTH_SHORT);
//				toast2.show();
				break;
			case 2:
				setExerciseScreen();
			...
			case 3:
				...
				break;
			case 4:
//				Toast toast3 = Toast.makeText(Activa.myApp, Activa.myLanguageManager.SENSORS_BLUETOOTH_NOTCONNECTED, Toast.LENGTH_SHORT);
//				toast3.show();
				Activa.myUIManager.loadInfoPopupWithoutExiting(Activa.myLanguageManager.SENSORS_BLUETOOTH_NOTCONNECTED);
				break;
			case 5:
//				Toast toast4 = Toast.makeText(Activa.myApp, Activa.myLanguageManager.SENSORS_BLUETOOTH_CONNECTING, Toast.LENGTH_SHORT);
//				toast4.show();
				Activa.myUIManager.loadInfoPopupWithoutExiting(Activa.myLanguageManager.SENSORS_BLUETOOTH_CONNECTING);
				break;
			case 6:
			...
			case 71:
				animation.start();
				Activa.myUIManager.updateExerciseScreen(0, 0, steps, stops, "2: ");
				break;
			case 100:
				Activa.myUIManager.loadScreen(R.layout.info);
				final TextView text2 = (TextView) Activa.myApp.findViewById(R.id.textInfo);
				text2.setText(Activa.myLanguageManager.SENSORS_EXERCISE_PREPULSI + ". " + Activa.myLanguageManager.SENSORS_EXERCISE_PULSIINS);
				final LinearLayout board = (LinearLayout) Activa.myApp.findViewById(R.id.mainLayout);
			...
			case 200:
				Activa.myUIManager.loadScreen(R.layout.info);
				final TextView text1 = (TextView) Activa.myApp.findViewById(R.id.textInfo);
				text1.setText(Activa.myLanguageManager.SENSORS_EXERCISE_POSTPULSI + ". " + Activa.myLanguageManager.SENSORS_EXERCISE_PULSIINS);
				final LinearLayout board2 = (LinearLayout) Activa.myApp.findViewById(R.id.mainLayout);
	...
	private void setExerciseScreen() {
		...
		confirm.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				finished = true;
				exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_DISTANCE, distance);
		    	exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_AVRG, -1f);
				exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_PEAK, -1f);
				exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_HR_LOW, -1f);
				exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_AVRG, -1f);
				exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_PEAK, -1f);
				exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_SO2_LOW, -1f);
				if (timePassed > time) timePassed = time;
				exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_TIME_EXE, (float)(timePassed/1000));
		    	exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_TIME_DATA, -1f);
		    	exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_STEPS, (float)steps);
		    	exercise.results.put(com.o2hlink.pimtools.data.sensor.SensorManager.DATAID_STOPS, (float)stops);
