...
public class Spirometer extends Sensor {
	...
	public String getSensorSampleForPending() {
		String returned = "<MEASUREMENT ID=\"" + com.o2hlink.pimtools.data.sensor.SensorManager.ID_SPIROMETER;
...
//			dateid.setTime(dateid.getTime() - dateid.getTimezoneOffset());
	...
	public String getSensorGlobalResult() {		
		...
		if ((Activa.myMobileManager.user.getBirthdate() == null)) {
			return "0:" + Activa.myLanguageManager.SENSORS_DATA_LACKOF;
		}
		...
		if (Activa.myMobileManager.user.getSex().equals(Sex.MALE)) {
		...
		else if (Activa.myMobileManager.user.getSex().equals(Sex.FEMALE))  {
			...
			result = "2:" + Activa.myLanguageManager.SENSORS_DATA_LACKOF;
			return result;
		}
