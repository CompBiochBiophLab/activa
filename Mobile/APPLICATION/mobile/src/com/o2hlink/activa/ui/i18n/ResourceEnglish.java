...
//		initialVideoURL = "http://c180889.r89.cf1.rackcdn.com/ActivaEnvironmentsDemo.mp4";
		...
		PSW_REG_ENTERDATA = "Introduce username and password: ";
		...
		PSW_INFO_USER = "User "; 
		PSW_INFO_REGISTERED = " well registred"; 
		...
		MAIN_ACTIVITIES = R.drawable.sensorseng;
		MAIN_MAP = R.drawable.mapeng;
		MAIN_MESSAGES = R.drawable.messageseng;
		MAIN_PROGRAMS = R.drawable.programseng;
		MAIN_QUEST = R.drawable.questionnaireseng;
		MAIN_SCHED = R.drawable.calendareng;
		MAIN_NEWS = R.drawable.newseng;
		MAIN_NOTES = R.drawable.noteseng;
		...
		SENSORS_BLUETOOTH_NOTCONNECTED = "Bluetooth not connected, connecting it (it will be disconnected after doing the measurement) ...";
		...
		SENSORS_EXERCISE_TRACKTIMES = "Track done: ";
	    ...
	    PROGRAMS_WALKING_MESSAGE0 = "START WALKING";
	    PROGRAMS_WALKING_MESSAGE1 = "WALK FAST, WITHOUT RUNNING";
	    PROGRAMS_WALKING_MESSAGE2 = "YOU ARE WORKING VERY GOOD, GO ON";
	    PROGRAMS_WALKING_MESSAGE3 = "YOU ARE WORKING VERY GOOD, GO ON";
	    PROGRAMS_WALKING_MESSAGE4 = "YOU ARE FINISHING, C'MON!";
		...
		NOTIFICATION_TITLE = "Activa - Notification";
		...
		TEXT_ABOUTUS = "<big>Version Beta %s Madrid</big><br/>" +
				"<br/>ActivA© presented by O2H™ and logos are trademarks registered by O2 Heart Link Inc. All rights reserved.<br/>" +
				"<br/>ActivA uses open source code under Apache 2.0 license.<br/>";
		...
		TEXT_PULSEOXYMETRY = "<br/>This measurement is done with a Nonin 4000 series Bluetooth pulse oximeter. For doing the measuremt you must follow this steps:<br/><br/>" +
		...
		TEXT_SIXMINUTESWALK = "<br/>This measurement is done with a Nonin 4000 series Bluetooth pulse oximeter. For doing the measuremt you must follow this steps:<br/><br/>" +
		...
		TEXT_EXERCISE = "<br/>This measurement is done with a Nonin 4000 series Bluetooth pulse oximeter. For doing the measurement you must follow this steps:<br/><br/>" +
				"1. Press over the event you want to do (either a calendar event or a measurement at sensor screen).<br/>" +
				"2. Answer the two initial questions related with air and fatigue.<br/>" + 
				"3. Turn on the pulse oximeter.<br/>" +
				"4. Place your finger on the pulse oximeter fingertip and attach the pulse oximeter to the wrist.<br/>" +
		...
		TEXT_UPDATEVERSION = "There was a problem during the connection to the server which may be caused because " +
				"you may be using a not updated version of ActivA. Please check if there is a more recent version " +
				"of the app.";
