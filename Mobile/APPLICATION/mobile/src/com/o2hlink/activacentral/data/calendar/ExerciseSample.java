package com.o2hlink.activacentral.data.calendar;
...
import com.o2hlink.activacentral.data.sensor.SensorManager;
...
//		this.setOxygenFinal(exercise.getOxygenFinal());
	...
	public Spanned getExerciseSpanData() {
		return Html.fromHtml(
			...
			"<b>" + Activa.myLanguageManager.SENSORS_DATA_FINAL_FAT + ": </b>" + String.format("%.1f", this.getFinalFatigue()) + " " + SensorManager.getUnitForMeasurement(SensorManager.getUnitIDForMeasurementID(SensorManager.DATAID_BORG_FATIGUE_POST)) + "<br/><br/>" +
