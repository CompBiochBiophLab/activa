...
import com.o2hlink.activacentral.ui.UIManager;
import com.o2hlink.activacentral.R;

public class SixMinutes extends com.o2hlink.activacentral.data.sensor.Sensor {
	...
	int[] order = {com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_HR_AVRG, com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_HR_PEAK, com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_HR_LOW, -1,
		com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_SO2_AVRG, com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_SO2_PEAK, com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_SO2_LOW, -1,
		com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_DISTANCE, com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_STEPS, com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_STOPS, -1,
		com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_TIME_EXE, com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_TIME_DATA};
	...
	public SixMinutes() {
		...
		this.id = com.o2hlink.activacentral.data.sensor.SensorManager.ID_SIXMINUTES;
		this.instance = this;
		this.state = 0;
	...
	public Sample getSample() {
		...
		sample.setFinalDyspnea(this.results.get(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_BORG_AIR_POST));
		sample.setFinalFatigue(this.results.get(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_BORG_FATIGUE_POST));
		sample.setInitialDyspnea(this.results.get(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_BORG_AIR_PRE));
		sample.setInitialFatigue(this.results.get(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_BORG_FATIGUE_PRE));
		sample.setDistance(this.results.get(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_DISTANCE));
		sample.setSteps(Float.valueOf(this.results.get(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_STEPS)).intValue());
		sample.setStops(Float.valueOf(this.results.get(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_STOPS)).intValue());
		sample.setTime(this.results.get(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_TIME_EXE));
		sample.setHeartRateAverage(this.results.get(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_HR_AVRG));
		sample.setHeartRateLow(this.results.get(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_HR_LOW));
		sample.setHeartRatePeak(this.results.get(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_HR_PEAK));
		sample.setOxygenAverage(this.results.get(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_SO2_AVRG));
		sample.setOxygenLow(this.results.get(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_SO2_LOW));
		sample.setOxygenPeak(this.results.get(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_SO2_PEAK));
	...
	public String getSensorSampleForPending() {
		String returned = "<MEASUREMENT ID=\"" + com.o2hlink.activacentral.data.sensor.SensorManager.ID_EXERCISE;
	...
	public static com.o2hlink.activacentral.data.sensor.Sensor getSampleFromPending(String xml) {
			...
			ok.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					try {
						...
						results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_DISTANCE, (lapsnumber*tracksize) + remaindernum);
	...
	public String getSensorGlobalResult() {
		String result;
		Float avrgSo2 = this.results.get(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_SO2_AVRG);
		if (avrgSo2 > 90.0) {
...
//			dateid.setTime(dateid.getTime() - dateid.getTimezoneOffset());
		...
		while (keys.hasMoreElements()) {
			int key = keys.nextElement();
			returned += "<DATA ID=\"" + key + "\" VALUE=\"" + this.results.get(key);
			returned += "\" UNITS=\"" + com.o2hlink.activacentral.data.sensor.SensorManager.getUnitIDForMeasurementID(key) + "\"/>";
		}
		returned += "</EVENT>";
		return returned;
	}
		...
		switch (this.state) {
			...
			case 3:
				...
				board.setOnClickListener(new OnClickListener() {
					@Override
					public void onClick(View v) {
						((SixMinutes) Activa.mySensorManager.sensorList.get(com.o2hlink.activacentral.data.sensor.SensorManager.ID_SIXMINUTES)).track = true;
			...
			case 7:
				this.state = 0;
				((SixMinutes) Activa.mySensorManager.sensorList.get(com.o2hlink.activacentral.data.sensor.SensorManager.ID_SIXMINUTES)).results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_BORG_AIR_PRE, borgAirPre);
				((SixMinutes) Activa.mySensorManager.sensorList.get(com.o2hlink.activacentral.data.sensor.SensorManager.ID_SIXMINUTES)).results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_BORG_AIR_POST, borgAirPost);
				((SixMinutes) Activa.mySensorManager.sensorList.get(com.o2hlink.activacentral.data.sensor.SensorManager.ID_SIXMINUTES)).results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_BORG_FATIGUE_PRE, borgFatiguePre);
				((SixMinutes) Activa.mySensorManager.sensorList.get(com.o2hlink.activacentral.data.sensor.SensorManager.ID_SIXMINUTES)).results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_BORG_FATIGUE_POST, borgFatiguePost);
				Activa.myApp.setContentView(R.layout.sending);
				SendSensorResult sending = new SendSensorResult(Activa.mySensorManager.sensorList.get(com.o2hlink.activacentral.data.sensor.SensorManager.ID_SIXMINUTES));
...
//								        soundpool.play(soundpoolmap.get(SYSTEMALERT_SOUND), streamVolume, streamVolume, 1, 0, 1f);
					    ...
					    if (finished) {
					    	...
					    	this.exercise.hrtrack.put(((float) this.timePassed/1000), this.lastHr);
					    	this.exercise.so2track.put(((float) this.timePassed/1000), this.lastSo2);
					    	exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_HR_AVRG, this.avrgHr);
					    	exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_HR_PEAK, this.peakHr);
					    	exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_HR_LOW, this.lowHr);
					    	exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_SO2_AVRG, this.avrgSo2);
					    	exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_SO2_PEAK, this.peakSo2);
					    	exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_SO2_LOW, this.lowSo2);
					    	exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_STEPS, (float)this.steps);
					    	exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_STOPS, (float)this.stops);
					    	exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_TIME_EXE, (float)(time/1000));
					    	exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_TIME_DATA, (float)(timeMeasured/1000));
...
//						temporizer.cancel();
				    	...
				    	exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_HR_AVRG, avrgHr);
						exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_HR_PEAK, peakHr);
						exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_HR_LOW, lowHr);
						exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_SO2_AVRG, avrgSo2);
						exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_SO2_PEAK, peakSo2);
						exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_SO2_LOW, lowSo2);
						if (timePassed > time) timePassed = time;
						exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_TIME_EXE, (float)(timePassed/1000));
				    	exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_TIME_DATA, (float)(timeMeasured/1000));
				    	exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_STEPS, (float)steps);
				    	exercise.results.put(com.o2hlink.activacentral.data.sensor.SensorManager.DATAID_STOPS, (float)stops);
				    	if (exercise.wakeLock != null) 
							if (exercise.wakeLock.isHeld())
								exercise.wakeLock.release();
				        exercise.nextStep();
