...
public final class ZonatedUtil
{
      /**
	...
	public static String monthOfDate (Date date) {
		...
		switch (date.getMonth() + 1) {
			case 1:
				returned = Zonated.myLanguageManager.MONTH_JANUARY;
				break;
			case 2:
				returned = Zonated.myLanguageManager.MONTH_FEBRUARY;
				break;
			case 3:
				returned = Zonated.myLanguageManager.MONTH_MARCH;
				break;
			case 4:
				returned = Zonated.myLanguageManager.MONTH_APRIL;
				break;
			case 5:
				returned = Zonated.myLanguageManager.MONTH_MAY;
				break;
			case 6:
				returned = Zonated.myLanguageManager.MONTH_JUNE;
				break;
			case 7:
				returned = Zonated.myLanguageManager.MONTH_JULY;
				break;
			case 8:
				returned = Zonated.myLanguageManager.MONTH_AUGUST;
				break;
			case 9:
				returned = Zonated.myLanguageManager.MONTH_SEPTEMBER;
				break;
			case 10:
				returned = Zonated.myLanguageManager.MONTH_OCTOBER;
				break;
			case 11:
				returned = Zonated.myLanguageManager.MONTH_NOVEMBER;
				break;
			case 12:
				returned = Zonated.myLanguageManager.MONTH_DECEMBER;
				break;
		}
		return returned;
	}
