...
public class ExerciseSample extends Exercise {
	...
	public Spanned getExerciseSpanData() {
		return Html.fromHtml(
			...
			"<b>" + HealthGenius.myLanguageManager.SENSORS_DATA_FINAL_FAT + ": </b>" + String.format("%.1f", this.getFinalFatigue()) + " " + SensorManager.getUnitForMeasurement(SensorManager.getUnitIDForMeasurementID(SensorManager.DATAID_BORG_FATIGUE_POST)) + "<br/><br/>" +
