...
public class SixMinutesWalkSample extends SixMinutesWalk {
	...
	public Spanned getExerciseSpanData() {
		return Html.fromHtml(
			"<big><b>" + HealthGenius.myLanguageManager.PATIENTS_HISTORY_EXERCISE + " " + HealthGeniusUtil.dateToReadableString(this.getDate()) + " " + HealthGeniusUtil.timeToReadableString(this.getDate()) + "</b></big><br/><br/>" +
			...
			"<b>" + HealthGenius.myLanguageManager.SENSORS_DATA_HR_PEAK + ": </b>" + (int) this.getHeartRatePeak() + " " + SensorManager.getUnitForMeasurement(SensorManager.getUnitIDForMeasurementID(SensorManager.DATAID_HR_PEAK)) + "<br/>" + 
			"<b>" + HealthGenius.myLanguageManager.SENSORS_DATA_HR_LOW + ": </b>" + (int) this.getHeartRateLow() + " " + SensorManager.getUnitForMeasurement(SensorManager.getUnitIDForMeasurementID(SensorManager.DATAID_HR_LOW)) + "<br/><br/>" + 
			...
			"<b>" + HealthGenius.myLanguageManager.SENSORS_DATA_SO2_PEAK + ": </b>" + (int) this.getOxygenPeak() + " " + SensorManager.getUnitForMeasurement(SensorManager.getUnitIDForMeasurementID(SensorManager.DATAID_SO2_PEAK)) + "<br/>" +
			"<b>" + HealthGenius.myLanguageManager.SENSORS_DATA_SO2_LOW + ": </b>" + (int) this.getOxygenLow() + " " + SensorManager.getUnitForMeasurement(SensorManager.getUnitIDForMeasurementID(SensorManager.DATAID_SO2_LOW)) + "<br/><br/>" +
			...
			"<b>" + HealthGenius.myLanguageManager.SENSORS_DATA_DISTANCE + ": </b>" + (int) this.getDistance() + " " + SensorManager.getUnitForMeasurement(SensorManager.getUnitIDForMeasurementID(SensorManager.DATAID_DISTANCE)) + "<br/><br/>" +
