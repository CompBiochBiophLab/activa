...
public class SixMinutes extends com.o2hlink.healthgenius.data.sensor.Sensor {
	...
	int[] order = {com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_HR_AVRG, com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_HR_PEAK, com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_HR_LOW, -1,
		com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_SO2_AVRG, com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_SO2_PEAK, com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_SO2_LOW, -1,
	...
	public SixMinutes() {
		this.name = HealthGenius.myLanguageManager.PROGRAMS_WALKING_TITLE;
		this.icon = R.drawable.animations;
		this.id = com.o2hlink.healthgenius.data.sensor.SensorManager.ID_SIXMINUTES;
		this.instance = this;
		this.state = 0;
		...
		this.timedMessages.put(60000l, HealthGenius.myLanguageManager.PROGRAMS_WALKING_MESSAGE0);
		this.timedMessages.put(120000l, HealthGenius.myLanguageManager.PROGRAMS_WALKING_MESSAGE1);
		this.timedMessages.put(180000l, HealthGenius.myLanguageManager.PROGRAMS_WALKING_MESSAGE2);
		this.timedMessages.put(240000l, HealthGenius.myLanguageManager.PROGRAMS_WALKING_MESSAGE3);
		this.timedMessages.put(300000l, HealthGenius.myLanguageManager.PROGRAMS_WALKING_MESSAGE4);
		this.timedMessages.put(330000l, HealthGenius.myLanguageManager.PROGRAMS_WALKING_MESSAGE5);
	}
	...
	public Sample getSample() {
		...
		sample.setDistance(this.results.get(com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_DISTANCE));
		...
		sample.setHeartRateAverage(this.results.get(com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_HR_AVRG));
		sample.setHeartRateLow(this.results.get(com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_HR_LOW));
		sample.setHeartRatePeak(this.results.get(com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_HR_PEAK));
		sample.setOxygenAverage(this.results.get(com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_SO2_AVRG));
		sample.setOxygenLow(this.results.get(com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_SO2_LOW));
		sample.setOxygenPeak(this.results.get(com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_SO2_PEAK));
	...
	public void finishMeasurements(final boolean outcome, Hashtable<Integer, Float> result) {
		...
		this.results = result;
		if (track&&outcome){
			HealthGenius.myUIManager.loadScreen(R.layout.sixminutesdata);
			((TextView) HealthGenius.myApp.findViewById(R.id.startText)).setText(HealthGenius.myLanguageManager.SENSORS_EXERCISE_TITLE);
			((TextView)HealthGenius.myApp.findViewById(R.id.requestLaps)).setText(HealthGenius.myLanguageManager.SENSORS_EXERCISE_TRACKTIMES);
			((TextView)HealthGenius.myApp.findViewById(R.id.requestTrack)).setText(HealthGenius.myLanguageManager.SENSORS_EXERCISE_TRACKLENGTH);
			((TextView)HealthGenius.myApp.findViewById(R.id.requestRemainder)).setText(HealthGenius.myLanguageManager.SENSORS_EXERCISE_REMAINDER);
			final EditText laps = (EditText) HealthGenius.myApp.findViewById(R.id.lapsText);
			final EditText size = (EditText) HealthGenius.myApp.findViewById(R.id.trackText);
			final EditText remainder = (EditText) HealthGenius.myApp.findViewById(R.id.remainderText);
			...
			ok.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					try {
						...
						results.put(com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_DISTANCE, (lapsnumber*tracksize) + remaindernum);
						...
						HealthGenius.myUIManager.UImeas.finishWalkingTest(name, outcome, instance, order);
					} catch (Exception e) {
			...
			HealthGenius.myUIManager.UImeas.finishWalkingTest(this.name, outcome, instance, order);
		}
	}
	...
	public void nextStep() {
		...
		switch (this.state) {
			...
			case 1:
				...
				text.setText(HealthGenius.myLanguageManager.PROGRAMS_WALKING_ADVERT0);
			...
			case 3:
				...
				text2.setText(HealthGenius.myLanguageManager.PROGRAMS_WALKING_ADVERT1);
				...
				board.setOnClickListener(new OnClickListener() {
					@Override
					public void onClick(View v) {
						((SixMinutes) HealthGenius.mySensorManager.sensorList.get(com.o2hlink.healthgenius.data.sensor.SensorManager.ID_SIXMINUTES)).track = true;
			...
			case 4:
				...
				text3.setText(HealthGenius.myLanguageManager.PROGRAMS_WALKING_ADVERT2);
			...
			case 7:
				this.state = 0;
				((SixMinutes) HealthGenius.mySensorManager.sensorList.get(com.o2hlink.healthgenius.data.sensor.SensorManager.ID_SIXMINUTES)).results.put(com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_BORG_AIR_PRE, borgAirPre);
				((SixMinutes) HealthGenius.mySensorManager.sensorList.get(com.o2hlink.healthgenius.data.sensor.SensorManager.ID_SIXMINUTES)).results.put(com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_BORG_AIR_POST, borgAirPost);
				((SixMinutes) HealthGenius.mySensorManager.sensorList.get(com.o2hlink.healthgenius.data.sensor.SensorManager.ID_SIXMINUTES)).results.put(com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_BORG_FATIGUE_PRE, borgFatiguePre);
				((SixMinutes) HealthGenius.mySensorManager.sensorList.get(com.o2hlink.healthgenius.data.sensor.SensorManager.ID_SIXMINUTES)).results.put(com.o2hlink.healthgenius.data.sensor.SensorManager.DATAID_BORG_FATIGUE_POST, borgFatiguePost);
				HealthGenius.myApp.setContentView(R.layout.sending);
				SendSensorResult sending = new SendSensorResult(HealthGenius.mySensorManager.sensorList.get(com.o2hlink.healthgenius.data.sensor.SensorManager.ID_SIXMINUTES));
...
//						socket.connect();
						...
						while ((!timeFinished)&&(this.finished)) {
				  		    try {
				  		    	...
				  		    	lost++;
				  		    	Log.d("EXERCISE", "Data lost ...");
				  		    	if (lost == 10) ((Vibrator)HealthGenius.myApp.getSystemService(Context.VIBRATOR_SERVICE)).vibrate(300);
				  		    	if (lost == 20) ((Vibrator)HealthGenius.myApp.getSystemService(Context.VIBRATOR_SERVICE)).vibrate(300);
				  		    	if (lost > 30) {
						    ...
						    if ((data[0] & 0x7C)!=0x00  || (data[0] & 0x03)==0x03)  {
								...
								if (bad == 20) ((Vibrator)HealthGenius.myApp.getSystemService(Context.VIBRATOR_SERVICE)).vibrate(300);
								if (bad == 30) ((Vibrator)HealthGenius.myApp.getSystemService(Context.VIBRATOR_SERVICE)).vibrate(300);
				  		    	if (bad == 30) {
				  		    		Log.d("EXERCISE", "Bad data: warning 2 ...");
//									streamVolume = HealthGenius.myAudioManager.getStreamVolume(HealthGenius.myAudioManager.STREAM_RING);
//									streamVolume = soundOn*(streamVolume/HealthGenius.myAudioManager.getStreamMaxVolume(HealthGenius.myAudioManager.STREAM_RING));
//							        soundpool.play(soundpoolmap.get(SYSTEMALERT_SOUND), streamVolume, streamVolume, 1, 0, 1f);
							    	handler.sendEmptyMessage(21);
				  		    	}
				  		    	if (bad == 40) ((Vibrator)HealthGenius.myApp.getSystemService(Context.VIBRATOR_SERVICE)).vibrate(300);
				  		    	if (bad == 50) ((Vibrator)HealthGenius.myApp.getSystemService(Context.VIBRATOR_SERVICE)).vibrate(300);
				  		    	if (bad == 60) {
...
//								        soundpool.play(soundpoolmap.get(SYSTEMALERT_SOUND), streamVolume, streamVolume, 1, 0, 1f);
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				animation.stop();	
				HealthGenius.myUIManager.UImeas.loadSixMinutesScreen(HealthGenius.myLanguageManager.SENSORS_WAITING_DATA, time);
