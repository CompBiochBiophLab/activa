package com.o2hlink.healthgenius.data.questionnaire.control;
...
public class QuestControlManager {
	...
	public void getQuestionnaires() {
		try {
			HealthGenius.myProtocolManager.getQuestList();
			HealthGenius.myProtocolManager.getAssignedQuestList();
	...
	public void startQuestionnaire(Questionnaire quest) {
		...
		this.activeAnswersAnswered = new Stack<QuestionAnswer>();
		this.activeQuestionsAnswered = new Stack<Question>();
		HealthGenius.myUIManager.UIquest.loadQuestion(this.activeQuestions.get(this.activeQuestionnaire.getFirst()));
	}
	...
	public void finishQuestionnaire() {
		...
		HealthGenius.myUIManager.UIquest.loadQuestResult(weight);
	}
...
//		if (maxWeight == 0.0d) return -1.0f;
	...
	public static String getSensorSampleForPending(Long questId, QuestionnaireSample sample) {
		...
		returned += "\" DATE=\"" + HealthGeniusUtil.dateToXMLDate(sample.getDate());
		returned += "\" EVENT=\"";
	...
	public boolean getAssignedQuestList() {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.getAssignedQuestList();
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
	...
	public boolean getQuestionnaire(long id) {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.getQuestionnaire(id);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
	...
	public Array<Questionnaire> SearchQuests(String query) {
		...
		try {
			result = HealthGenius.myProtocolManager.SearchQuests(query);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = null;
	...
	public boolean shareQuestionnaire(ArrayList<Long> users, Questionnaire questionnaire) {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.shareQuestionnaire(users, questionnaire);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
	...
	public boolean removeQuestionnaire(Questionnaire quest) {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.removeQuestionnaire(quest);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
	...
	public boolean createQuestionnaire(String quest) {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.createQuestionnaire(quest);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
	...
	public boolean publishQuestionnaire(Questionnaire quest) {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.publishQuestionnaire(quest);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
	...
	public boolean removeQuestion(Question quest) {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.removeQuestion(quest);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
	...
	public boolean updateQuestionnaire(Questionnaire questionnaire) {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.updateQuestionnaire(questionnaire);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
	...
	public Question addQuestion(Question question) {
		Question result;
		try {
			result = HealthGenius.myProtocolManager.addQuestion(question);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = null;
	...
	public boolean updateQuestion(Question prevQest) {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.updateQuestion(prevQest);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
	...
	public boolean removeAnswer(Long id, Answer answer) {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.removeAnswer(id, answer);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
	...
	public boolean removeCondition(Long id, Condition condition) {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.removeCondition(id, condition);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
	...
	public boolean addAnswer(Long id, Answer answer) {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.addAnswer(id, answer);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
	...
	public boolean updateAnswer(Long id, Answer answer) {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.updateAnswer(id, answer);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
	...
	public boolean addCondition(Long id, Condition condition) {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.addCondition(id, condition);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
	...
	public boolean updateCondition(Long id, Condition condition) {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.updateCondition(id, condition);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
	...
	public boolean sendQuestionnaire(Long questionnaire, QuestionnaireSample sample) {
		boolean result;
		try {
			result = HealthGenius.myProtocolManager.sendQuestionnaire(questionnaire, sample);
		} catch (NotUpdatedException e) {
			HealthGenius.myUIManager.UImisc.loadTextOnWindow(HealthGenius.myLanguageManager.TEXT_UPDATEVERSION);
			e.printStackTrace();
			result = false;
