...
//		initialVideoURL = "http://c180889.r89.cf1.rackcdn.com/ActivaEnvironmentsDemo.mp4";
		...
		NOTIFICATION_TITLE = "Health Genius - Notification";
		...
		TEXT_ABOUTUS = "<big>Version %s Madrid</big><br/>" +
				"<br/>Health Genius© presented by O2H™ and logos are trademarks registered by O2 Health Link Inc. All rights reserved.<br/>" +
				"<br/>Health Genius uses open source code under Apache 2.0 license.<br/>";
		...
		TEXT_UPDATEVERSION = "There was a problem during the connection to the server which may be caused because " +
				"you may be using a not updated version of Health Genius. Please check if there is a more recent version " +
				"of the app.";
		...
		TEXT_GOTOACTIVACENTRAL = "If you want to use this widget, download Health Genius";
		...
		TEXT_NOTRESEARCHERS = "You must have a Health Genius patient or clinician account";
