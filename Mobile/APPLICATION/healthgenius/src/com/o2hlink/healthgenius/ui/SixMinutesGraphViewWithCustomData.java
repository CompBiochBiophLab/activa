...
//		canvas.drawText(HealthGenius.myLanguageManager.SENSORS_SIXMIN_HRCHAT_LEGENDY, 37, 18, hrline);
//		canvas.drawText(HealthGenius.myLanguageManager.SENSORS_SIXMIN_SO2CHAT_LEGENDY, 37, 28, so2line);
		// Draw vertical axis and legend
		canvas.drawLine(30, 20, 30, height - 20, axis);
//		canvas.drawText(HealthGenius.myLanguageManager.SENSORS_SIXMIN_TIMECHAT_LEGENDX, (float)(width) - 55, height - 50, axis);
		// Draw vertical marks
