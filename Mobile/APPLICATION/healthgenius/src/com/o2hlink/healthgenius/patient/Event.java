...
public class Event {
	...
	public Event() {
		...
		this.subtype = -1l;
		this.state = 1;
		this.userId = HealthGenius.myMobileManager.userForServices.getId();
	}
			...
			switch (this.type) {
				case 0:
					run = new Runnable() {
						@Override
						public void run() {
							if (HealthGenius.myPatientManager.getMeasurementSample(event))
						...
						private Handler handler = new Handler() {
							...
							public void handleMessage(Message msg) {
								...
								switch (msg.what) {
									case 0:
										HealthGenius.myUIManager.UImisc.loadInfoPopupWithoutExiting(HealthGenius.myLanguageManager.CALENDAR_LOADING);
									...
									case 1:
										if (subtype.equals(com.o2hlink.healthgenius.data.sensor.SensorManager.ID_PULSIOXYMETER)) {
											HealthGenius.myUIManager.UIpatient.showMeasResults(sample, false);
										}
										else if (subtype.equals(com.o2hlink.healthgenius.data.sensor.SensorManager.ID_SPIROMETER)) {
											HealthGenius.myPatientManager.getSpiroGraphs(userId, sample.getDate(), sample);
											HealthGenius.myUIManager.UIpatient.showMeasResults(sample, false);
										}
										else if (subtype.equals(com.o2hlink.healthgenius.data.sensor.SensorManager.ID_SIXMINUTES)) {
											HealthGenius.myPatientManager.getSixMinutesGraphs(userId, sample.getDate(), sample);
											HealthGenius.myUIManager.UIpatient.showMeasResults(sample, false);
										}	
				...
				case 1:
					run = new Runnable() {
						...
						public void run() {
							...
							boolean success = HealthGenius.myPatientManager.getQuestSample(event);
							...
							public void handleMessage(Message msg) {
								...
								switch (msg.what) {
									...
									case 1:
										...
										animation.stop();
										animationFrame.setVisibility(View.GONE);
										HealthGenius.myUIManager.UIpatient.showQuestResults((com.o2hlink.activ8.client.entity.QuestionnaireSample) questsample, false, name);
										break;
									case 2:
										animationFrame = (ImageView) HealthGenius.myApp.findViewById(R.id.popupImage);
										animation = (AnimationDrawable) animationFrame.getBackground();
	...
	public void setAlert() {
		if (state != 0) {
			...
			CharSequence from = HealthGenius.myLanguageManager.NOTIFICATION_TITLE;
