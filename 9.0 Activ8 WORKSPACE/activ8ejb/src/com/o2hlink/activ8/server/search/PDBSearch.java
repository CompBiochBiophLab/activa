...
import com.o2hlink.activ8.server.local.PDBLocal;
 ...
 **/
@Service
public class PDBSearch implements SearchPlugin{
//FIELDS
	/**
	 * 
	 **/
...
//CONSTRUCTOR
	...
	public List<HasSummary> search(String query, int start, int offset) {
		...
		for (HasSummary protein:pdbsession.getProteins(query, start, offset))
			result.add(protein);
		return result;
	}
	/**
