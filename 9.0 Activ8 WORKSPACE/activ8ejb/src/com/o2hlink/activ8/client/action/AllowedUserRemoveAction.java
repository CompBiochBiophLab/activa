...
/**
 * Given an object implementing {@link HasPrivacyPolicy} remove a particular user 
 * @author Miguel Angel Hernandez
 **/
public class AllowedUserRemoveAction implements Action<VoidResponse> {
//FIELDS
	/**
	 * 
	 **/
	private static final long serialVersionUID = 207585687876475350L;
	/**
	 * 
	 **/
...
//CONSTRUCTOR
	 ...
	 * 
	 **/
	public AllowedUserRemoveAction(){
		
	}
	/**
	 * 
	 **/
	public AllowedUserRemoveAction(HasPrivacyPolicy provider, User user){
