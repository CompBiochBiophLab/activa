 ...
 **/
public class SentRequestsGetAction implements Action<IncomingContactRequestListResponse> {
//FIELDS
	/**
	 * 
	 */
	private static final long serialVersionUID = -6863621380894696370L;
	/**
	 * 
	 **/
	private User user;
//CONSTRUCTOR
	 ...
	 **/
	public SentRequestsGetAction(){
		
	}
	/**
	 * 
	 **/
	public SentRequestsGetAction(User user){
		setUser(user);
	}
//METHODS
	/**
