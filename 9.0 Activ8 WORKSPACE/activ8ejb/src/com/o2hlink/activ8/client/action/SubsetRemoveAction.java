...
/**
 * Removes a subset from a dataset
 * @author Miguel Angel Hernandez
 **/
public class SubsetRemoveAction implements Action<VoidResponse> {
//FIELDS
	/**
	 * 
	 */
...
//CONSTRUCTOR
	 ...
	 **/
	public SubsetRemoveAction(){
		
	}
	/**
	 * 
	 **/
	public SubsetRemoveAction(Dataset dataset, Subset subset){
		setDataset(dataset);
		setSubset(subset);
	}
//METHODS
