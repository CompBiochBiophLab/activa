...
/**
 * Creates a new history record for a patient.
 * @author Miguel Angel Hernandez
 **/
public class HistoryRecordNewAction implements Action<HistoryRecordResponse> {
//FIELDS
	/**
	 * 
	 */
...
//CONSTRUCTOR
	 ...
	 * 
	 **/
	public HistoryRecordNewAction(){
		
	}
	/**
	 * 
	 **/
	public HistoryRecordNewAction(Patient patient, HistoryRecord record){
		setPatient(patient);
