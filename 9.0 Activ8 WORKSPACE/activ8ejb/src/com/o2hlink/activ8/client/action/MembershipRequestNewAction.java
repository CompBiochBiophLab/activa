 ...
 **/
public class MembershipRequestNewAction implements Action<VoidResponse> {
//FIELDS
	/**
	 * 
	 **/
...
//CONSTRUCTOR
	 ...
	 **/
	public MembershipRequestNewAction(){
		
	}
	/**
	 * 
	 **/
	public MembershipRequestNewAction(Group group, User user, String message){
		this.setGroup(group);
		this.setUser(user);
