...
//CONSTRUCTOR
	...
	public AccountThemeWidget(){
		...
		gallery.add(addScene("Standard", "models/clinico.o3dtgz", "images/clinico_thumbnail.png"));
		gallery.add(addScene("Minimal", "models/clinico.o3dtgz", "images/clinico_min_thumbnail.png"));
